...
const PROMPT_TEMPLATE_PATH = path.join(__dirname, 'prompts', 'StepBuilderAgent.prompt.txt');

async function StepBuilderAgent(plan, currentCode, stepDescription, mode) {
