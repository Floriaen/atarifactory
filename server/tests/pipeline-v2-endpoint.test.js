...
describe('POST /api/pipeline-v2/generate', () => {
  ...
  it('should run the full pipeline with the correct llmClient and produce LLM-driven outputs', async () => {
    ...
    let feedback = require('../agents/FeedbackAgent')({ runtimeLogs: runtimeResult, stepId: planWithError.length }, { logger: llmClient.logger || console, traceId: 'test', llmClient: mockOpenAI });
