...
const { createPlannerChain } = require("../../agents/langchain/chains/PlannerChain");
...
describe("PlannerChain Pipeline Tests", () => {
  ...
  describe("Prompt Template", () => {
    it("loads prompt file and checks content", async () => {
      const promptPath = path.join(__dirname, "../../agents/langchain/prompts/PlannerChain.prompt.md");
