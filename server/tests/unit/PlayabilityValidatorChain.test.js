...
const { createPlayabilityValidatorChain } = require("../../agents/langchain/PlayabilityValidatorChain");
...
describe("PlayabilityValidatorChain Pipeline Tests", () => {
  ...
  describe("Prompt Template", () => {
    it("loads prompt file and checks content", async () => {
      const promptPath = path.join(__dirname, "../../agents/prompts/PlayabilityValidatorAgent.prompt.md");
