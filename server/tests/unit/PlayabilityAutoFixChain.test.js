...
const { createPlayabilityAutoFixChain } = require("../../agents/langchain/PlayabilityAutoFixChain");
...
describe("PlayabilityAutoFixChain Pipeline Tests", () => {
  ...
  describe("Prompt Template", () => {
    it("loads prompt file and checks content", async () => {
      const promptPath = path.join(__dirname, "../../agents/prompts/PlayabilityAutoFixAgent.prompt.md");
